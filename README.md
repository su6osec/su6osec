...
**Subdomain discovery & validation CLI**

Aggregates **39 free OSINT sources**, runs concurrent DNS / TLS / HTTP validation, and reports only verified results using a confidence scoring algorithm.

![Go](https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=white)
![License](https://img.shields.io/github/license/su6osec/graphite?style=flat-square&color=6366f1)
![Stars](https://img.shields.io/github/stars/su6osec/graphite?style=flat-square&color=6366f1)
...
### [nyx](https://github.com/su6osec/nyx)
**Modular recon platform**

25+ scanner modules — port scanning, secrets hunting, CORS audit, headers analysis, JS analysis, and more. Designed for fast, pipeline-friendly automation.

![Go](https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=white)
![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![License](https://img.shields.io/github/license/su6osec/nyx?style=flat-square&color=6366f1)
![Stars](https://img.shields.io/github/stars/su6osec/nyx?style=flat-square&color=6366f1)

```
# 25+ scanners under one roof
nyx scan -d example.com --all
```
